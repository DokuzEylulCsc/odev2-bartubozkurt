...
namespace BartuBozkurt2017280013
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if ((sayi < 0) || (sayi > 3999))
                MessageBox.Show("Lütfen 1 ile 3999 arası sayı giriniz!");
            ...
            textBox3.Text += dbinler[binler] + " ";
            textBox3.Text += dyuzler[yuzler] + " ";
            textBox3.Text += donlar[onlar];
            textBox3.Text += " " + dbirler[birler];
        }
    ...
    // https://www.bilisimogretmeni.com/visual-studio-c/c-ornekleri-girilen-sayiyi-roma-rakamlarina-cevirme.html
    // https://mustafabukulmez.com/2019/01/05/c-girilen-sayiyi-roma-rakamina-cevirmek/
    // https://www.bilisimkonulari.com/c-sayiyi-roma-rakamina-ceviren-program.html
}
